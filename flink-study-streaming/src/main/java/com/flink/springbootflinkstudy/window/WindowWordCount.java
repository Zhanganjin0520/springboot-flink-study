...
package com.flink.springbootflinkstudy.window;

import java.time.Duration;

import com.flink.springbootflinkstudy.workcount.WordCountStreamDemo;
...
public class WindowWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> counts =
                ...
                text.flatMap(new WordCountStreamDemo.Tokenizer())
                        .name("tokenizer")
